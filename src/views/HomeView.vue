...
<template>
  <div class="Welcome">
    <h2>As melhores viagens você faz aqui!</h2>
  </div>
  <div class="Popu">
    <h3>As queridinhas do momento:</h3>
  </div>
  <div class="card-group">
    <div class="card">
      <img
        src="https://viagemeturismo.abril.com.br/wp-content/uploads/2017/12/istock-842960000.jpg"
        class="card-img-top img-destino"
        alt="..."
      />
      <div class="card-body">
    ...
    <div class="card">
      <img
        src="https://viagemeturismo.abril.com.br/wp-content/uploads/2016/12/10-9n.jpg"
        class="card-img-top"
        alt="..."
        height="221px"
      />
      <div class="card-body">
        ...
        <a href="/about" class="btn btn-primary">Ver mais</a>
      </div>
    </div>
    <div class="card">
      <img
        src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcToyAXuD8CRdDkBypi3QYpaGiOiyrEKRDqTLg&usqp=CAU"
        class="card-img-top"
        alt="..."
        height="221px"
      />
      <div class="card-body">
        ...
        <p class="card-text">
          3 dias em Fernando de Noronha, com passagem de ida e volta, estadia em
          em pousada de frente pro mar, almoço e guia turistico inclusos.
          <br />
  ...
  <div class="exterior">
    <div class="card-group">
      <div class="card">
        <img
          src="https://veja.abril.com.br/wp-content/uploads/2018/08/0620zu_3567rw.jpeg"
          class="card-img-top"
          height="221px"
          alt="..."
        />
      ...
      <div class="card">
        <img
          src="https://upload.wikimedia.org/wikipedia/commons/8/8a/Paris_vue_d%27ensemble_tour_Eiffel.jpg"
          class="card-img-top"
          alt="..."
          height="221px"
        />
      ...
      <div class="card">
        <img
          src="https://q5e5q6q7.stackpathcdn.com/wp-content/uploads/2017/09/Kyoto.jpg"
          class="card-img-top"
          alt="..."
          height="221px"
        />
        <div class="card-body">
          ...
          <p class="card-text">
            4 dias na Cidade dos samurais, com passagem de ida e volta, estadia
            em em pousada a 600 metros do centro, almoço e guia turistico
            inclusos.
            <br />
